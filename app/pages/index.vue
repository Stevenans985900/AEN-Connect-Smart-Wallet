  ...
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      ...
      <v-card>
        ...
        <v-card-text>
          <p>You are receiving this message because you don't yet have a wallet setup, please choose from the
          options below</p>
          <p>
          ...
          <v-layout>
            ...
            <!-- summary -->
            <v-flex v-if="walletExists === true" xs12 md6 class="text-xs-center">
              <v-card>
                <v-card-text>
    ...
    export default {
        ...
        computed: {
            ...
            walletName: {
                ...
                set: function (inputValue) {
                    this.$store.commit('setAccountProperty', {key: 'name', value: inputValue})
                }
            },
            walletPassword: {
                get: function () {
                ...
                set: function (inputValue) {
                    this.$store.commit('setAccountProperty', {key: 'password', value: inputValue})
                }
            },
            privateKey: {
                get: function () {
                ...
                set: function (inputValue) {
                    this.$store.commit('setAccountProperty', {key: 'private_key', value: inputValue})
                }
            }
        },
        watch: {
            ...
            backupUploaded(file) {
                ...
                fileUploadedEmitter.on('ready', function (walletData) {
                    ...
                    try {
                        ...
                        message = 'Backup loaded, please enter your password in the provided field'
