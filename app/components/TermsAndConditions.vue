<template>
  <v-layout row wrap justify-center align-center class="text-xs-center">
    <v-flex xs12 md10>
      <p>
        This Privacy Policy describes the policies and procedures of Aenco Ltd. (“we,” “our,” or “us”) pertaining to the collection, use, and disclosure of your information on www.trustwalletapp.com and related mobile applications and products we offer (the “Services” or “AEN Connect”).
      </p>
      <h3>
        OVERVIEW
      </h3>
      <p>
        Your privacy is important to us. At AEN Connect, we follow a few fundamental principles:
      </p>
      <ul>
        <li>We don’t ask you for personally identifiable information (defined below). That being said, your contact information, such as your phone number, social media handle, or email address (depending on how you contact us), may be collected when you communicate with us or if you report a bug or other error related to AEN Connect.</li>
        <li>We don’t share your information with third parties except to deliver you our Services and products, comply with the law, make AEN Connect better, protect our rights, or effectuate a business transfer.</li>
        <li>We’re not a huge, faceless corporation. We’re just developers trying to deliver an incredible product. If you have any questions or concerns about this policy, please reach out to us at support@aencoin.com.</li>
      </ul>
      ...
      <p>
        By using AEN Connect, including downloading one of our mobile applications, visiting our website, you agree to the use, disclosure, and procedures outlined in this Privacy Policy.
      </p>
      ...
      <p>
        We do our best not to collect any Personal Information from AEN Connect users.  That being said, when using our Services, we do collect PUBlIC wallet addresses that you generate through AEN Connect. Further, we may collect some Personal Information from you when you communicate with us, including your contact information, such as your phone number, social media handle, or email address (depending on how you reach out).
      </p>
      <p>
        Like other online services, we also collect a variety of Non-Personal Information, including:
      </p>
      <p>
        Information you create through the AEN Connect’s website or mobile applications, including public wallet addresses.       Various analytics data, such as: (i) the IP address of the computer you use to access AEN Connect; (ii) the type of browser software you are using; (iii) the operating system you are using; (iv) the date and time you access or use AEN Connect; (v) the website address, if any, that linked you to AEN Connect; (vi) the website address, if any, you leave our website and travel to; and (vii) other non-personally identifiable traffic data.
      </p>
      <h3>
      ...
      <ul>
        ...
        <li>Respond to your comments, questions, or issues related to bugs or errors with AEN Connect;</li>
        <li>Provide you with additional information;</li>
        <li>Send you information and marketing materials about services and products available through AEN Connect, using push notifications or other means;</li>
      ...
      <p>
        We reserve the right to access, read, preserve, and disclose any information that we reasonably believe is necessary to: comply with the law or a court order; cooperate with law enforcement; enforce or apply our Terms of Use and other agreements; or protect the rights, property, or safety of AEN Connect, our employees, our users, or others.
      </p>
      <h3>
        WHAT PERSONAL INFORMATION CAN I ACCESS OR CHANGE?
      </h3>
      <p>
        You can request access to the information we have collected from you. You can do this by contacting us at support@aencoin.com. We will make sure to provide you with a copy of the data we process about you. To comply with your request, we may ask you to verify your identity. We will fulfil your request by sending your copy electronically. For any subsequent access request, we may charge you with an administrative fee.
      </p>
      <p>
        If you believe that the information we have collected is incorrect, you are welcome to contact us so we can update it and keep your data accurate. Any data that is no longer needed for purposes specified in the “How We Use the Information We Gather” section will be deleted after ninety (90) days. Wallet addresses created through the AEN Connect application cannot be deleted from the Ethereum blockchain, therefore we are unable to delete this personal information.
      </p>
      <p>
        If at any point you wish for AEN Connect to delete information about you, you may contact us at support@aencoin.com.
      </p>
      <h3>
        DATA RETENTION
      </h3>
      <p>
        If you delete your Wallet or addresses from the AEN Connect Android mobile application, uninstall AEN Connect mobile applications from your device, or request that your information be deleted, we still may retain some information that you have provided to us to maintain AEN Connect or to comply with relevant laws.
      </p>
      <h3>
        DATA SECURITY
      </h3>
